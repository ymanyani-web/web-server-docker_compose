...
if (isset($_POST['pw1']) && is_null($_POST['pw1']))
{
    if( $_POST['pw1'] == $_POST['pw2'])
    {
        ...
        header('Location: ../view/log_in.php?t=1');
    }
    else 
...
if(isset($_POST['user']) || isset($_POST['email']))
{
    ...
    if(!empty($_POST['user']))
    {
        ...
        else
        {
            ...
            session_destroy();    
            echo '<script> window.location.replace("../view/log_in.php?t=2");</script>';
        }
    }
        ...
        if(!empty($_POST['email']))
        {
            ...
            else
            {
                ...
                $req->execute(array(
                    ...
                    session_destroy(); 
                    echo '<script> window.location.replace("../view/log_in.php?t=3");</script>';
            }
        }
    }
?>